// ====== СЛОВА (ваш список) ======
const VOCAB = [
 { en: "Waveform", ru: "осциллограмма; форма сигнала", pron: "ВЭЙВ-форм" },
{ en: "Match", ru: "соответствие; совпадать", pron: "МЭТЧ" },
{ en: "Input", ru: "вход; входной сигнал", pron: "ИН-пут" },
{ en: "Complete", ru: "завершенный; полный", pron: "кэм-ПЛИТ" },
{ en: "Significance", ru: "значимость; важность", pron: "сиг-НИ-фи-кэнс" },
{ en: "Times", ru: "разы; времена", pron: "ТАЙМЗ" },
{ en: "Capacity", ru: "емкость; вместимость", pron: "кэ-ПЭ-си-ти" },
{ en: "Elapsed", ru: "прошедший (о времени)", pron: "и-ЛЭПСТ" },
{ en: "To elapse", ru: "проходить; истекать (о времени)", pron: "ту и-ЛЭПС" },
{ en: "Set", ru: "набор; устанавливать", pron: "СЭТ" },
{ en: "Amount", ru: "количество; сумма", pron: "э-МАУНТ" },
{ en: "Perform", ru: "выполнять; исполнять", pron: "пэр-ФОРМ" },
{ en: "Timing", ru: "тайминг; расчет времени", pron: "ТАЙ-мин" },
{ en: "Introduction", ru: "введение; знакомство", pron: "ин-трэ-ДАК-шн" },
{ en: "Previous", ru: "предыдущий", pron: "ПРИ-ви-эс" },
{ en: "Stacked", ru: "сложенный в стопку; многослойный", pron: "СТЭКТ" },
{ en: "Access", ru: "доступ", pron: "ЭК-сесс" },
{ en: "Multiple", ru: "множественный; составной", pron: "МАЛ-ти-пл" },
{ en: "To multiply", ru: "умножать", pron: "ту МАЛ-ти-плай" },
{ en: "Determines", ru: "определяет", pron: "ди-ТЁР-минз" },
{ en: "Elapsed", ru: "прошедший; истекший", pron: "и-ЛЭПСТ" },
{ en: "Consists", ru: "состоит (из чего-либо)", pron: "кэн-СИСТС" },
];
